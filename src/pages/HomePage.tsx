    ...
    <>
        ...
        <div className="container grid items-center gap-12 py-20 lg:grid-cols-2 lg:py-28">
          ...
          >
            <span className="inline-flex items-center gap-1.5 rounded-full bg-primary/10 px-3 py-1 text-xs font-semibold text-primary">
              <Star className="h-3 w-3" /> Student Rewards Platform
            </span>
            ...
            <p className="mt-4 max-w-lg text-lg text-muted-foreground">
              CampusPerks connects students with local businesses. Every purchase earns you points, discounts, and exclusive perks.
            </p>
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-3">
            {steps.map((step, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                variants={fadeUp}
                className="relative rounded-2xl border border-border bg-card p-8 shadow-card transition-shadow hover:shadow-card-hover"
              >
                <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-primary/10 text-primary">
                  {step.icon}
                </div>
                <div className="absolute -top-3 right-6 flex h-6 w-6 items-center justify-center rounded-full bg-primary font-display text-xs font-bold text-primary-foreground">
                  {i + 1}
                </div>
            ...
            {vendors.map((v, i) => (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <div className="mt-3 inline-flex rounded-full bg-accent/10 px-2.5 py-1 text-xs font-medium text-accent">
                    🎁 {v.offer}
                  </div>
                </div>
              </motion.div>
      ...
      <section className="bg-hero-gradient py-20">
        <div className="container text-center">
          <h2 className="font-display text-3xl font-bold text-primary-foreground">Why CampusPerks?</h2>
          <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                variants={fadeUp}
                className="rounded-2xl bg-primary-foreground/10 backdrop-blur-sm p-6 text-primary-foreground"
              >
                <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-xl bg-primary-foreground/20">
                  {item.icon}
                </div>
      ...
      <section className="py-20">
        <div className="container text-center">
          ...
          <p className="mt-3 text-lg text-muted-foreground">
            Join CampusPerks today and unlock rewards at your favorite local spots.
          </p>
