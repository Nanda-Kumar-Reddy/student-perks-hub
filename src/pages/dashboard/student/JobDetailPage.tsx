...
const jobs = [
  ...
  },
  {
    ...
    fullDesc: "BrandHouse is seeking a creative and organized Marketing Coordinator to manage our marketing campaigns across digital and traditional channels.",
  ...
  },
  {
    ...
    fullDesc: "Bean Counter Café is a popular specialty coffee shop in the heart of Melbourne CBD. We're looking for an enthusiastic barista to join our team.",
  ...
  },
  {
    ...
    fullDesc: "The University Bookstore is looking for a friendly and organized Retail Assistant to help serve our student community.",
  ...
  },
  {
    ...
    fullDesc: "TechCorp is hiring a part-time IT Support specialist to assist our team remotely. This is an excellent opportunity for IT students to gain real-world experience while studying.",
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-5">
        ...
        <div className="lg:col-span-3 space-y-4">
          ...
          {/* Requirements (now includes experience & education) */}
          <div className="rounded-xl border border-border bg-card p-5 space-y-3">
            <h2 className="font-display text-base font-bold flex items-center gap-2">
            ...
            <ul className="space-y-2">
              <li className="flex items-start gap-2 text-sm text-muted-foreground">
                ...
                <span><strong>Experience:</strong> {job.overview.experience}</span>
              </li>
              <li className="flex items-start gap-2 text-sm text-muted-foreground">
                <CheckCircle2 className="mt-0.5 h-3.5 w-3.5 shrink-0 text-primary" />
                <span><strong>Education:</strong> {job.overview.education}</span>
              </li>
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="rounded-xl border border-border bg-card p-5 space-y-3">
            ...
            <div className="flex flex-wrap gap-2">
              {job.benefits.map((b) => (
                <span key={b} className="rounded-lg bg-secondary px-3 py-2 text-xs font-medium text-foreground">{b}</span>
              ))}
            </div>
          </div>
